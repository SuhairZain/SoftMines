...
static const char qt_meta_stringdata_Stepper[] = {
    "Stepper\0\0valueChanged(int)\0onMinusClicked()\0"
    "onPlusClicked()\0"
};
...
const QMetaObjectExtraData Stepper::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Stepper::staticMetaObject = {
    { &Container::staticMetaObject, qt_meta_stringdata_Stepper,
      qt_meta_data_Stepper, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Stepper::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Stepper))
...
// SIGNAL 0
void Stepper::valueChanged(int _t1)
{
